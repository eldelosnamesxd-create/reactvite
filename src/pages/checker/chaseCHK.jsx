...
//import "./card.css"
export default function Chasechk({ gate, }) {
                                                ...
                                                <div className="form-floating">
                                                    <div id="chkbocontent" style={gate == "amazon_us" ? { display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", height: "30px" } : { display: "none", alignItems: "center", justifyContent: "center", gap: "10px", height: "30px" }} >
                                                        <label style={{ display: "flex", alignItems: "center", cursor: "pointer" }}>
                                                            ...
                                                            <input id="generate" type="checkbox" className="checkbox-custom" checked={false} />
                                                        </label>
                                                    </div>
                                                    <div id="ccscontainer" style={{ display: "block" }}>
                                                    ...
                                                    <div id="ccscontainergen" style={gate == "amazon_us" ? { display: "block" } : { display: "none" }}>
                                                    ...
                                                    <br />
                                                    <div id="concookies" style={gate == "amazon_us" ? { display: "block" } : { display: "none" }}>
